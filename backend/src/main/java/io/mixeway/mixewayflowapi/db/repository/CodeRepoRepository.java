...
public interface CodeRepoRepository extends CrudRepository<CodeRepo, Long> {
    ...
    @Query("SELECT new io.mixeway.mixewayflowapi.api.coderepo.dto.GetCodeReposResponseDto(c.id, c.name, c.repourl, t.name, c.sastScan, c.iacScan, c.secretsScan, c.scaScan, c.gitlabScan, c.dastScan, c.exploitabilityScan) FROM CodeRepo c JOIN c.team t WHERE t IN :teams")
