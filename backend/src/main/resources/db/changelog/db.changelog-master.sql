...
CREATE TABLE settings_exploitability (
                            ...
                            api_call_delay_seconds real,
                            default_top_k INTEGER,
                            max_chunks_for_analysis INTEGER,
                            file_filter_mode VARCHAR(255),
                            custom_extensions VARCHAR(255),
                            max_file_size_mb real,
                            max_file_lines INTEGER,
                            warn_file_size_mb real,
                            warn_file_lines INTEGER,
                            max_files_for_testing INTEGER,
                            embedding_batch_size INTEGER,
                            max_chunk_size_mb real,
                            max_total_chunks INTEGER,
                            memory_limit_gb real,
                            max_preprocessing_chars INTEGER,
                            max_organization_chars INTEGER,
                            enable_chunk_subdivision boolean,
                            max_chunks_per_file INTEGER,
                            chunking_parallel_workers INTEGER,
